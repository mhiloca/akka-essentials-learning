...
//  val routine: Cancellable = system.scheduler.scheduleAtFixedRate(1 second, 2 seconds, simpleActor, "heartbeat")
...
//  }
   ...
   *
   * - if the actor receives a message (anything), you have to 1 second to send it another message
