...
object Mailboxes extends App {
  ...
  class SimpleActor extends Actor with ActorLogging {
    ...
    override def postStop(): Unit = {
      log.info(s"[${self.path.name}] I have stopped")
    }
  ...
  // step 1- setup mailbox definition
...
//  supportTicketLogger ! "[P3] this thing would bem nice to have"
...
//  supportTicketLogger ! "[P1] do this when you have the time"
  ...
  /*
    ...
    - make the actor attach to the mailbox (instead of the dispatcher)
   */

  // method #1
  val controlAwareActor = system.actorOf(Props[SimpleActor].withMailbox("control-mailbox"))
//  controlAwareActor ! "[P3] this thing would bem nice to have"
...
//  controlAwareActor ! ManagementTicket
  ...
  altControlAwareActor ! "[P3] this thing would bem nice to have"
